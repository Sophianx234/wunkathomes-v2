    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-16 border-t border-black/10">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => scroll('right')} className="w-10 h-10 rounded-full border-2 border-black flex items-center justify-center text-black hover:bg-black hover:text-white transition-colors">
      ...
      >
        {similar.map((property, index) => (
          <div key={property.id} className="min-w-[300px] md:min-w-[400px] flex-shrink-0 snap-start">
