...
const pillars = [
  {
    ...
    description: "We are not a marketplace. We own, design, and manage 100% of our portfolio. This means zero third-party landlords, zero fake listings, and absolutely no broker fees.",
    icon: Building04Icon,
    image: "/a-5.jpg"
  },
  {
    ...
    description: "The era of physical paperwork is over. Review transparent terms, verify your identity, and sign legally binding tenancy agreements entirely from your device in minutes.",
    icon: File02Icon,
  ...
  },
  {
    ...
    description: "Physical keys are a security risk. The moment your hybrid payment clears our ledger, a unique, encrypted Tuya smart-lock PIN is generated on your dashboard.",
    icon: Key01Icon,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 w-full">
          ...
          >
            ...
            <p className="text-sm md:text-base text-slate-600 font-medium leading-relaxed max-w-sm md:text-right">
              We don't rely on third parties to dictate your living experience. We built the infrastructure from the ground up to guarantee peace of mind.
            </p>
          </motion.div>
        </div>
          ...
          {pillars.map((pillar, index) => {
            ...
            return (
              ...
              >
                ...
                {/* --- Image Block --- */}
                <div className={`relative h-[300px] sm:h-[350px] lg:h-[450px] xl:h-[500px] overflow-hidden group 
