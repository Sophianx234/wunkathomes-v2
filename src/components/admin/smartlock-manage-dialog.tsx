              ...
              <div className="p-4 bg-white rounded-lg border border-zinc-200 space-y-4">
                {newPin ? (
                  <div className="bg-zinc-50 border border-zinc-200 rounded p-4 text-center">
                    ...
                    <p className="text-[11px] text-zinc-600 mt-2">Copy this code now. It will not be shown again.</p>
                    ...
                    <div key={idx} className="flex items-center justify-between p-3 bg-white border border-zinc-200 rounded-lg">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          disabled={isPending}
                          className="text-[11px] font-bold text-zinc-600 hover:underline disabled:opacity-50"
                        >
                          Revoke
                        </button>
                      </div>
                    ...
                    <div key={log._id} className="group relative flex gap-4 p-4 hover:bg-zinc-50 transition-colors border-b border-zinc-100 last:border-0">
                      ...
                      <div className="flex-shrink-0 pt-0.5">
                        {log.actorId ? (
                          ...
                          <div className="h-8 w-8 rounded-full bg-zinc-100 flex items-center justify-center text-zinc-600 ring-1 ring-zinc-200">
                      ...
                      <div className="flex-1 min-w-0 flex flex-col gap-0.5">
                        ...
                        <div className="flex items-center justify-between mt-1.5">
                          <span className={`text-[12px] ${isAlarm ? 'text-zinc-600 font-semibold' : 'text-zinc-700 font-medium'}`}>
