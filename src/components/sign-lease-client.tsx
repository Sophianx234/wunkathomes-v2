      ...
      <div className="w-full md:w-2/5 lg:w-1/3 bg-zinc-950 text-white flex flex-col justify-center p-8 lg:p-12 shadow-2xl relative z-10 ">
        ...
        >
          ...
          <form onSubmit={handleSign} className="space-y-8 mb-auto">
            {/* Consent Checkbox */}
            <label className="flex items-start gap-4 cursor-pointer group p-4 border border-zinc-800 rounded-xl hover:bg-black transition-colors">
              <div className="relative flex items-center justify-center mt-1 shrink-0">
                <input
                  ...
                  className="peer appearance-none w-5 h-5 border-2 border-zinc-600 rounded bg-zinc-950 focus:ring-2 focus:ring-primary/50 checked:bg-black checked:border-primary transition-all cursor-pointer"
                />
                <HugeiconsIcon
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 p-4 bg-black border border-zinc-800 rounded-xl text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all font-medium placeholder:text-zinc-700"
                />
              </div>
            </div>
