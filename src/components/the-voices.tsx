...
const testimonials = [
  {
    id: 1,
    quote: "I landed at Kotoka at 11 PM. By 11:45 PM, I was in my East Legon penthouse using a PIN generated on my phone. WunkatHomes hasn't just improved real estate; they’ve completely digitized it.",
    author: "Marcus T.",
  ...
  {
    id: 2,
    quote: "Privacy is my absolute highest priority. The fact that I could lease a secure diplomatic residence without dealing with a chain of third-party agents or physical keys is unprecedented.",
    author: "Elena R.",
  ...
  {
    id: 3,
    quote: "I paid my yearly lease balance via a bank transfer from London. The Admin ledger cleared it in hours, and my Tuya smart-lock activated instantly. This is how global living should be.",
    author: "Jonathan K.",
              ...
              <div className="flex items-center gap-4 md:gap-5">
                ...
                <div>
                  ...
                  <div className="text-xs md:text-sm font-medium text-slate-500 mt-0.5">
                    {currentTestimonial.role} <span className="text-slate-300 mx-1.5">|</span> {currentTestimonial.location}
                  </div>
                </div>
              </div>
