...
// Import your new Receipt Component
...
export default function SuccessReceipt({ transaction }: SuccessReceiptProps) {
  // NEW: State to trigger the full-screen receipt view
  ...
  // =====================================================================
  if (isViewingReceipt) {
    // We map the raw transaction data to the shape TransactionReceipt expects
  ...
  return (
    <div className="max-w-2xl mx-auto w-full font-sans">
      ...
      >
        ...
        >
          <HugeiconsIcon icon={PrinterIcon} size={16} /> View Official Receipt
        </button>
