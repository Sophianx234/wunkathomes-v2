    ...
    <section className="relative w-full h-[calc(100vh-5rem)] min-h-[500px] bg-black overflow-hidden flex flex-col justify-end pb-28 md:pb-36">
      ...
      <div className="relative  z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row justify-between items-end gap-8 md:gap-12">
        ...
        <div className="max-w-3xl">
          ...
          >
            Step into an exclusive portfolio of properties owned and managed entirely by WunkatHomes. No agents. No friction. Just flawless living.
          </motion.p>
          ...
          >
            <Link href="/properties">
              <button className="w-full sm:w-auto px-6 md:px-8 py-3 md:py-4 bg-white text-black font-bold uppercase rounded-md tracking-widest text-[10px] md:text-xs hover:bg-black hover:text-white border-2 border-white transition-all duration-300 flex items-center justify-center gap-3 group">
                View Portfolio
