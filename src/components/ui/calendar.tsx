  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-black text-white hover:bg-zinc-800 hover:text-white focus:bg-black focus:text-white shadow-md shadow-black/20",
        day_today: "bg-zinc-100/80 text-black",
        day_outside:
          "day-outside text-zinc-300 font-medium aria-selected:bg-zinc-100 aria-selected:text-zinc-500",
