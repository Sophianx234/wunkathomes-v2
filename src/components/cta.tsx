      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-8 lg:p-12 xl:p-16 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tight leading-[1.1] text-white mb-5">
            Welcome to <br />
            <span className=" font-light text-white/50">effortless living.</span>
          </h2>

          {/* Persuasive Body Copy */}
          <p className="text-sm md:text-base text-white/60 font-light leading-relaxed mb-8 md:mb-10">
            Join hundreds of families who have discovered a better way to move. Skip the endless paperwork and hidden fees. simply find your perfect space, book securely, and step right in.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 md:gap-4">
            ...
            <Link href="/explore?status=sale" className="w-full sm:w-auto">
              <button className="w-full rounded-md px-6 py-3.5 md:py-4 bg-transparent text-white font-black uppercase tracking-widest text-[10px] md:text-xs border border-white/30 hover:border-white transition-colors duration-300 flex items-center justify-center gap-3 ">
                Explore Ownership
              </button>
            </Link>
          </div>
