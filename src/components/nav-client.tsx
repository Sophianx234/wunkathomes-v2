...
// Define the exact shape of the data coming from the Server Component
...
export default function NavbarClient({ user }: NavbarClientProps) {
  // We determine if they are logged in based on whether the server passed user data
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20 relative">
          ...
          <div
            className="hidden md:flex items-center gap-4 z-50 shrink-0 relative"
            ref={profileRef}
          >
            ...
            {isLoggedIn ? (
              <>
                <button
                  ...
                  className="flex items-center gap-2 border pr-6 border-slate-200 rounded-full p-1.5  transition-all bg-white focus:outline-none hover:shadow-xs"
                >
                  {user.profilePicture ? (
                  ...
                  <div className="flex flex-col ">
                    <div className="text-left text-[12px] font-medium">
                      {user.name}
                    </div>
                    ...
                    >
                      ...
                      <div className="py-2 border-b border-slate-100">
                        ...
                        <Link
                          ...
                          className="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 transition"
                        >
                          <HugeiconsIcon icon={FavouriteIcon} size={18} /> My
                          Saved Homes
                        </Link>
                        <Link
                          href="/user/leases"
                          ...
                          className="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 transition"
                        >
                          <HugeiconsIcon icon={File01Icon} size={18} /> My
                          Leases / Bookings
                        </Link>
                        <Link
                          ...
                          className="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 transition"
                        >
                          <HugeiconsIcon icon={CreditCardPosIcon} size={18} />{" "}
                          My Payment History
                        </Link>
                      </div>
        ...
        {menuOpen && (
          ...
          >
            <div className="flex flex-col px-6 py-6 overflow-y-auto max-h-[calc(100vh-5rem)]">
              {/* Conditional Mobile Profile Header */}
              {isLoggedIn && (
              ...
              {/* Main Site Links (Expanded for Mobile) - Always Visible */}
                ...
                <>
                  <nav className="flex flex-col gap-4 mb-6 pb-6 border-b border-slate-100">
                    ...
                    <Link
                      ...
                      className="flex items-center gap-3 text-lg font-medium text-slate-700 hover:text-slate-900 transition"
                    >
                      <HugeiconsIcon icon={FavouriteIcon} size={20} /> My Saved
                      Homes
                    </Link>
                    <Link
                      href="/user/leases"
                      ...
                      className="flex items-center gap-3 text-lg font-medium text-slate-700 hover:text-slate-900 transition"
                    >
                      <HugeiconsIcon icon={File01Icon} size={20} /> My Leases /
                      Bookings
                    </Link>
                  </nav>
