    ...
    <div className="lg:col-span-4 lg:-translate-y-8 w-full lg:w-[300px] lg:ml-auto relative">
      ...
      ">
          ...
          {step !== "IDLE" && (
            <div className="flex justify-between items-center mb-4 pb-3 border-b border-black/10 w-full box-border">
              ...
              {!hasBookedTour && (
                <button
                  onClick={resetFlow}
                  className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest hover:text-black shrink-0"
                >
                  Close
                </button>
              )}
        ...
        <div className="hidden lg:block mb-8 shrink-0 w-full box-border">
          <span className="text-sm font-bold uppercase tracking-widest text-zinc-500 block mb-2">
        ...
        <div className={`flex-col w-full max-w-full box-border gap-2 lg:gap-3 mt-auto transition-all duration-300 ${step === 'IDLE' ? 'hidden lg:flex' : 'flex max-h-[70vh] overflow-y-auto overflow-x-hidden pb-2 lg:pb-0'}`}>
          ...
          {step === "DATE" && (
            <div className="flex flex-col w-full min-w-0 max-w-full box-border gap-2 lg:gap-3 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <button
                ...
                className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold flex items-center gap-1 mb-1 hover:text-black w-fit shrink-0"
              >
              ...
              <button
                ...
                className="block w-full min-w-0 max-w-full box-border py-3 lg:py-4 bg-black text-white font-black uppercase tracking-widest text-[10px] lg:text-xs rounded-lg hover:bg-zinc-800 transition-colors mt-2 disabled:opacity-30 disabled:cursor-not-allowed shrink-0"
              >
                Continue
              </button>
            </div>
          ...
          {step === "SUCCESS" && (
            <div className="flex flex-col w-full max-w-full box-border items-center justify-center text-center gap-2 py-4 animate-in fade-in zoom-in-95 duration-300">
              ...
              <p className="text-[10px] lg:text-xs font-medium text-zinc-500 mb-4 lg:mb-6 leading-relaxed w-full box-border px-2">
