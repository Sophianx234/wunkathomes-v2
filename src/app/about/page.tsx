        ...
        <section className="relative bg-[url('/a-4.jpg')] bg-cover bg-center bg-no-repeat">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-white ">
            ...
            <p className="text-lg md:text-xl text-gray-200 leading-relaxed drop-shadow">
              WunkatHomes is on a mission to make quality living accessible. We
              provide affordable, well-managed rooms with a seamless booking
              experience. no agents, no surprises.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-16 px-6 lg:px-12">
            ...
            <div className="relative">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                At{" "}
                <span className="font-semibold text-gray-900">WunkatHomes</span>
                , our mission is to make quality living simple, affordable, and
                stress-free. We provide thoughtfully designed rooms that bring
                comfort and convenience within reach.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed mb-10">
                With transparent pricing, flexible bookings, and reliable
                service, we take the hassle out of finding your next home so you
                can focus on what truly matters: living comfortably.
              </p>
