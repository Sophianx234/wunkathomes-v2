    ...
    <div className="max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="mb-10">
        ...
        <p className="text-sm font-medium text-slate-500">
          Your Wunkat Command Center. Review your active ledgers and asset statuses.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          <div className="bg-white border-2 border-black rounded-2xl p-6 md:p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden">
            ...
            <p className="text-sm text-slate-600 font-medium leading-relaxed mb-8 max-w-md">
              Your refundable hold for <strong className="text-black">{activeTask.propertyName}</strong> is active. Please review and digitally sign your legally binding Tenancy Agreement to proceed to the physical inspection.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              ...
              <div className="flex items-center gap-2 text-xs font-bold text-slate-500 uppercase tracking-widest">
                ...
                Hold Expires in: <span className="text-black">{activeTask.holdExpiry}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 md:p-8">
            <div className="flex items-center justify-between mb-6 border-b border-slate-200 pb-4">
              <h3 className="text-sm font-black uppercase tracking-widest flex items-center gap-2">
                <HugeiconsIcon icon={Key01Icon} size={18} className="text-slate-400" />
            ...
            <p className="text-xs font-medium text-slate-500 leading-relaxed mb-6">
              Your Tuya Smart-Lock credentials are currently locked. Complete the digital ledger execution above to generate your temporary inspection PIN.
            </p>

            <button disabled className="w-full py-4 bg-white text-slate-400 font-black uppercase tracking-widest text-xs border-2 border-slate-200 rounded-xl cursor-not-allowed flex items-center justify-center gap-2">
        ...
        <div className="lg:col-span-1 flex flex-col gap-6">
            ...
            <div className="p-6">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex justify-between items-center pb-3 border-b border-slate-100">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Escrow Hold</span>
                  <span className="text-xs font-black text-green-600">{activeTask.depositPaid}</span>
                </div>
                <div className="flex justify-between items-center pb-3 border-b border-slate-100">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Verification</span>
                  <span className="text-[10px] font-bold text-slate-700 flex items-center gap-1">
                    <HugeiconsIcon icon={CheckmarkBadge01Icon} size={12} className="text-blue-500" />
                    Cleared
                  </span>
                </div>
              </div>

              <Link href={`/properties/glasshouse-villa`} className="w-full flex items-center justify-between text-xs font-bold uppercase tracking-widest text-slate-500 hover:text-black transition-colors group">
                View Digital Twin 
          ...
          <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
             <h4 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Need Assistance?</h4>
             <p className="text-xs font-medium text-slate-600 mb-4">
               Your dedicated Portfolio Manager is available to assist with your ledger execution.
             </p>
